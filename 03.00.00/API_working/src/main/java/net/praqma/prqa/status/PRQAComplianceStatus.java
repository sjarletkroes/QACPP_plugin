...
public class PRQAComplianceStatus extends PRQAStatus implements Comparable<PRQAComplianceStatus> {
    ...
    public Number getReadout(StatusCategory cat) throws PrqaException {
        ...
        switch (cat) {
            ...
            case FileCompliance:
                ...
                return output;
            default:
                if (this.getClass() != PRQAQualityStatus.class){
                    ...
                    logger.warning(String.format("*************Exception thrown type: %s; message: %s", exception.getClass(), exception.getMessage()));
                    throw exception;
                } else {
                    PrqaReadingException exception = new PrqaReadingException(String.format("Didn't find category %s for class %s", cat, this.getClass()));
     ...
     *
     * @param o
     * @return the value 0 if the argument o is equal to this
     * PRQAComplianceStatus; a value less than 0 if this PRQAComplianceStatus is
     * worse than o; and a value greater than 0 if this PRQAComplianceStatus is
     * better than o.
     */
    @Override
    ...
    /**
     * Returns the html table containing the compliance data and nb of messages.
     *
     * @return String
     */
    public String complianceToHtml() {
        StringBuilder sb = new StringBuilder();
        sb.append("<table class=\"pane\" style=\"margin-top: 0px;\">");
        sb.append("<tr style=\"border: 1px solid #BBB\">");
        sb.append("<th style=\"background-color: #F0F0F0; border: 1px solid #BBB\" align=\"left\">Messages within threshold</th>");
        sb.append(String.format("<td>%s</td>", this.getMessagesWithinThreshold()));
        sb.append("<tr style=\"border: 1px solid #BBB\">");
        sb.append("<th style=\"background-color: #F0F0F0; border: 1px solid #BBB\" align=\"left\">All messages</th>");
        sb.append(String.format("<td>%s</td>", this.getMessages()));
        sb.append("<tr style=\"border: 1px solid #BBB\">");
        sb.append("<th style=\"background-color: #F0F0F0; border: 1px solid #BBB\" align=\"left\">Project Compliance</th>");
        sb.append(String.format("<td>%s%s</td>", this.getProjectCompliance(), '%'));
        sb.append("<tr style=\"border: 1px solid #BBB\">");
        sb.append("<th style=\"background-color: #F0F0F0; border: 1px solid #BBB\" align=\"left\">File Compliance</th>");
    ...
    /**
     * Returns the html table containing the messages per level.
     *
     * @return String
     */
    public String messagesToHtml() {
        StringBuilder sb = new StringBuilder();
        ...
        for (int i : getMessagesByLevel().keySet()) {
            sb.append("<tr style=\"border: 1px solid #BBB\">");
            sb.append(String.format("<th align=\"left\" style=\"background-color: #F0F0F0; border: 1px solid #BBB\">%s</th>", i));
