 ...
 * @author T0166941
 */
public class PRQAFQualityReportHtmlParser extends ReportHtmlParser {
    ...
    public PRQAFQualityReportHtmlParser() { }

    public PRQAFQualityReportHtmlParser(String fullReportPath) {
